...
public class DbmlAliasClauseImpl extends ASTWrapperPsiElement implements DbmlAliasClause {

  public DbmlAliasClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DbmlVisitor visitor) {
    visitor.visitAliasClause(this);
  }
  ...
  public PsiElement getKwAs() {
    return findNotNullChildByType(KW_AS);
  }
