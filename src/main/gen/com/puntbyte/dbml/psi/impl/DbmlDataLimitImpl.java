...
public class DbmlDataLimitImpl extends ASTWrapperPsiElement implements DbmlDataLimit {

  public DbmlDataLimitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DbmlVisitor visitor) {
    visitor.visitDataLimit(this);
  }
