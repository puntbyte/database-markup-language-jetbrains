...
public class DbmlCheckBlockImpl extends ASTWrapperPsiElement implements DbmlCheckBlock {

  public DbmlCheckBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DbmlCheckItem> getCheckItemList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DbmlCheckItem.class);
  }
