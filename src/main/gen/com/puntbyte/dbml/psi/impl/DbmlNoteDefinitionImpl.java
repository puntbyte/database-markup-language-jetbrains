...
public class DbmlNoteDefinitionImpl extends ASTWrapperPsiElement implements DbmlNoteDefinition {

  public DbmlNoteDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DbmlVisitor visitor) {
    visitor.visitNoteDefinition(this);
  }
