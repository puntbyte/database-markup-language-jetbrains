...
public class DbmlInlineRefImpl extends ASTWrapperPsiElement implements DbmlInlineRef {

  public DbmlInlineRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DbmlVisitor visitor) {
    visitor.visitInlineRef(this);
  }
