...
public class DbmlColumnTypeImpl extends ASTWrapperPsiElement implements DbmlColumnType {

  public DbmlColumnTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DbmlVisitor visitor) {
    visitor.visitColumnType(this);
  }
  ...
  @Override
  @Nullable
  public DbmlDataLimit getDataLimit() {
    return findChildByClass(DbmlDataLimit.class);
  }
