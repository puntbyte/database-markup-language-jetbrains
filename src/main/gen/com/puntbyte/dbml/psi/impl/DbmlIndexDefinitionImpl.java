...
public class DbmlIndexDefinitionImpl extends ASTWrapperPsiElement implements DbmlIndexDefinition {

  public DbmlIndexDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public DbmlIndexBlock getIndexBlock() {
    return findNotNullChildByClass(DbmlIndexBlock.class);
  }

  @Override
  @NotNull
  public PsiElement getKwIndexes() {
    return findNotNullChildByType(KW_INDEXES);
  }
