...
public class DbmlReferenceBlockImpl extends ASTWrapperPsiElement implements DbmlReferenceBlock {

  public DbmlReferenceBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DbmlVisitor visitor) {
    visitor.visitReferenceBlock(this);
  }
  ...
  public DbmlReferenceExpression getReferenceExpression() {
    return findNotNullChildByClass(DbmlReferenceExpression.class);
  }
