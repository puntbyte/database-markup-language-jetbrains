...
public class DbmlColumnIdentifierImpl extends ASTWrapperPsiElement implements DbmlColumnIdentifier {

  public DbmlColumnIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
