...
public class DbmlNamespaceIdentifierImpl extends ASTWrapperPsiElement implements DbmlNamespaceIdentifier {

  public DbmlNamespaceIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DbmlId> getIdList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DbmlId.class);
  }
