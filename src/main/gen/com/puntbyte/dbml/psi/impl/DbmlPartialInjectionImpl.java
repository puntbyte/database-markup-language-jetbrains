...
public class DbmlPartialInjectionImpl extends ASTWrapperPsiElement implements DbmlPartialInjection {

  public DbmlPartialInjectionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DbmlVisitor visitor) {
    visitor.visitPartialInjection(this);
  }
