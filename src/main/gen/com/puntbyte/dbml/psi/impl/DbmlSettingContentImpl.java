...
public class DbmlSettingContentImpl extends ASTWrapperPsiElement implements DbmlSettingContent {

  public DbmlSettingContentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DbmlVisitor visitor) {
    visitor.visitSettingContent(this);
  }
  ...
  @Override
  @Nullable
  public DbmlMapEntry getMapEntry() {
    return findChildByClass(DbmlMapEntry.class);
  }
