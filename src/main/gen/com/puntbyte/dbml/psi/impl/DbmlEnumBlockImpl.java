...
public class DbmlEnumBlockImpl extends ASTWrapperPsiElement implements DbmlEnumBlock {

  public DbmlEnumBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DbmlEnumValue> getEnumValueList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DbmlEnumValue.class);
  }
